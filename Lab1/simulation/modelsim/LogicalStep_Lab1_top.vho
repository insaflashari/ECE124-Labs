...
-- Equation(s):
-- \inst5|OUT_4~0_combout\ = \sw[1]~input_o\ $ (((\PB[0]~input_o\) # (\PB[1]~input_o\)))
...
-- Equation(s):
-- \inst8|inst3~0_combout\ = \PB[0]~input_o\ $ (\sw[1]~input_o\ $ (\PB[1]~input_o\))
...
-- Equation(s):
-- \inst8|inst2~combout\ = \sw[1]~input_o\ $ (((!\PB[1]~input_o\) # (!\PB[0]~input_o\)))
